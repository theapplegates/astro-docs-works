...
[![Open in StackBlitz](httpss://developer.stackblitz.com/img/open_in_stackblitz.svg)](httpss://stackblitz.com/github/withastro/astro/tree/latest/examples/docs)

![docs](httpss://user-images.githubusercontent.com/4677417/186189283-0831b9ab-d6b9-485d-8955-3057e532ab31.png)
...
To deploy your site to production, check out our [Deploy an Astro Website](httpss://docs.astro.build/guides/deploy) guide.

## New to Astro?

Welcome! Check out [our documentation](httpss://docs.astro.build) or jump into our [Discord server](httpss://astro.build/chat).
...
If you've never worked with CSS variables before, give [MDN's guide on CSS variables](httpss://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties) a quick read.
...
[Algolia](httpss://www.algolia.com/) offers a free service to qualified open source projects called [DocSearch](httpss://docsearch.algolia.com/). If you are accepted to the DocSearch program, provide your API Key & index name in `src/config.ts` and a search box will automatically appear in your site header.
